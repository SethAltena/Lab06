 ...
 * for CS 262, lab 6
 *
 * 1. Displays the text "Failed to connect to service"
 * 2. Gets and displays information from an external database
 * 3. It looks really confusing
 * 4. Converts it to "an arraylist suitable for a listview adapter"
 * 5. Convert time stamps to days
 *
 *
 * @author kvlinden, Seth Altena
 * @version summer, 2016
 */
